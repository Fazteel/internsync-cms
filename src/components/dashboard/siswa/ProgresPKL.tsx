    ...
    <div className="rounded-2xl border border-gray-200 bg-gray-50 dark:border-gray-800 dark:bg-white/[0.03] shadow-sm">
      <div className="px-5 pt-5 bg-white rounded-t-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
        <div className="flex justify-between">
          <div>
            ...
            <p className="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
              Durasi magang yang telah berjalan
            </p>
          </div>
          ...
          <div className="relative inline-block">
            ...
            >
              <DropdownItem
                ...
                className="flex w-full font-normal text-left text-gray-600 rounded-lg hover:bg-brand-50 hover:text-brand-600 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-brand-400 transition-colors"
              >
                Lihat Detail
              </DropdownItem>
            </Dropdown>
        ...
        <p className="mx-auto mt-10 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base leading-relaxed">
          Kerja bagus! Anda telah menyelesaikan setengah dari total masa magang. Tetap semangat mengisi logbook harian!
        </p>
      </div>
      ...
      <div className="flex items-center justify-center gap-5 px-6 py-4 sm:gap-8 sm:py-5">
        ...
        <div>
          <p className="mb-1 text-center font-medium text-gray-500 text-theme-xs dark:text-gray-400 sm:text-sm uppercase tracking-wider">
            Total Durasi
          </p>
          <p className="flex items-center justify-center gap-1 text-base font-bold text-gray-800 dark:text-white/90 sm:text-lg">
            90 Hari
          </p>
        </div>
        ...
        <div>
          ...
          <p className="flex items-center justify-center gap-1 text-base font-bold text-brand-600 dark:text-brand-400 sm:text-lg">
            45 Hari
          </p>
        </div>
        ...
        <div>
          ...
          <p className="flex items-center justify-center gap-1 text-base font-bold text-accent-500 sm:text-lg">
            45 Hari
          </p>
        </div>
