...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 flex w-full bg-brand-50 border-brand-200 z-30 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-brand-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          <button
            className="items-center justify-center w-10 h-10 text-brand-600 bg-white border border-brand-200 rounded-lg z-30 hover:bg-brand-100 dark:border-gray-800 lg:flex dark:text-gray-400 lg:h-11 lg:w-11 dark:bg-transparent"
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 text-brand-600 rounded-lg z-30 hover:bg-brand-100 dark:text-gray-400 dark:hover:bg-gray-800 lg:hidden"
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
