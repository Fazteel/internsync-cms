...
export default function HubinAppicationsList() {
    ...
    useEffect(() => {
        fetchPendingApprovals('pengajuan');
    ...
    return (
        <>
            <PageMeta title="ACC Pengajuan | InternSync" description="Persetujuan pengajuan PKL oleh Hubin." />
            <div className="space-y-6">
                <PageHeader
                    title="Approval Pengajuan PKL"
                    description="Daftar antrian pengajuan prakerin dari Koordinator yang menunggu persetujuan."
                >
                ...
                <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] shadow-sm">
                    <div className="px-8 pt-6">
                        <TableTopControls rowsPerPage={rowsPerPage} setRowsPerPage={setRowsPerPage} totalData={applications.length} setCurrentPage={setCurrentPage} />
                    </div>
                        ...
                        <Table>
                            <TableHeader className="bg-gray-50/50 dark:bg-gray-800/20">
                                <TableRow>
                                    ...
                                    <TableCell isHeader className="py-3 px-4 text-start w-[20%]">Periode</TableCell>
                            ...
                            <TableBody>
                                {paginatedData.length === 0 ? (
                                    <TableRow><TableCell colSpan={6} className="py-10 text-center text-gray-500">Tidak ada antrian pengajuan.</TableCell></TableRow>
                                    ...
                                    return (
                                        <TableRow key={app.id} className="hover:bg-gray-50/50 transition-colors border-b border-gray-100 dark:border-gray-800">
                                            ...
                                            <TableCell className="py-5 px-4 text-start text-theme-xs text-gray-500 font-medium">
                                                {app.suggested_start_date} s.d {app.suggested_end_date}
                                            </TableCell>
