...
const mockDetail: StudentDetail = {
  ...
  email: "fahmi.andika@siswa.smk.id",
  startDate: "10 Agustus 2026",
  endDate: "10 Februari 2027",
};
            ...
            <div className="p-5 border border-brand-100 bg-brand-50/50 rounded-2xl dark:border-brand-900/30 dark:bg-brand-900/10 lg:p-6 shadow-sm">
              <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
                  <div className="w-20 h-20 overflow-hidden border-2 border-white rounded-full dark:border-gray-800 flex items-center justify-center bg-brand-500 text-white text-3xl font-bold flex-shrink-0 shadow-theme-xs">
                    {mockDetail.name.charAt(0)}
                  </div>
                  <div className="order-3 xl:order-2">
                    ...
                    <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                      ...
                      <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
                        NIS: <span className="font-bold text-gray-800 dark:text-gray-300">{mockDetail.nis}</span>
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-center xl:justify-end mt-4 xl:mt-0 flex-shrink-0">
                  <Badge color={mockDetail.status === "Aktif" ? "success" : mockDetail.status === "Selesai" ? "primary" : "error"}>
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                  <div>
                    ...
                    <div className="bg-white p-3 rounded-xl border border-gray-100 shadow-sm dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <p className="text-xs text-gray-500 mt-1 line-clamp-2">{mockDetail.address}</p>
                    </div>
                  </div>
