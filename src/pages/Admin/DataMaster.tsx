      ...
      <div className="space-y-6">
        ...
        >
          <div className="flex flex-wrap items-center gap-3">
            <a 
              href="/templates/template_masters.xlsx" 
              download="template_masters.xlsx"
              className="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 transition-colors cursor-pointer group"
            >
